...
export type PermissionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"createdAt" | "updatedAt" | "id" | "groupId" | "code" | "name" | "description" | "createdBy" | "updatedBy", ExtArgs["result"]["permission"]>
...
export interface PermissionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const permissionWithCreatedAtOnly = await prisma.permission.findMany({ select: { createdAt: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Permissions and only return the `createdAt`
   * const permissionWithCreatedAtOnly = await prisma.permission.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Permissions and only return the `createdAt`
   * const permissionWithCreatedAtOnly = await prisma.permission.updateManyAndReturn({
   *   select: { createdAt: true },
   *   where: {
   *     // ... provide filter here
   *   },
