...
export interface RolePermissionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const rolePermissionWithCreatedAtOnly = await prisma.rolePermission.findMany({ select: { createdAt: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many RolePermissions and only return the `createdAt`
   * const rolePermissionWithCreatedAtOnly = await prisma.rolePermission.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more RolePermissions and only return the `createdAt`
   * const rolePermissionWithCreatedAtOnly = await prisma.rolePermission.updateManyAndReturn({
   *   select: { createdAt: true },
   *   where: {
   *     // ... provide filter here
   *   },
